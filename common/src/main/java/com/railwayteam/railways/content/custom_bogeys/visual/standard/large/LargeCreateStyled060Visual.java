...
public class LargeCreateStyled060Visual implements BogeyVisual {
    ...
    private final TransformedInstance semiBlindWheel;
    ...
    public LargeCreateStyled060Visual(VisualizationContext ctx, float partialTick, boolean inContraption) {
        ...
        // 创建半盲轮
        semiBlindWheel = ctx.instancerProvider()
        ...
        pins = new TransformedInstance[3]; // -1, 0, 1
        for (int i = 0; i < 3; i++) {
    ...
    public void update(CompoundTag bogeyData, float wheelAngle, PoseStack poseStack) {
        ...
        // 更新中心半盲轮
        semiBlindWheel.setTransform(poseStack)
                .scale(1 - 1 / 512f)
                .translate(0, 1, 0)
                .rotateXDegrees(wheelAngle)
                .translate(0, -1, 0)
