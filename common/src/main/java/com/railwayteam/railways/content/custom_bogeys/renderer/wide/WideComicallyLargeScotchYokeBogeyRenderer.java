...
public class WideComicallyLargeScotchYokeBogeyRenderer implements BogeyRenderer {
    ...
    public void render(CompoundTag bogeyData, float wheelAngle, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int light, int overlay, boolean inContraption) {
        ...
        SuperByteBuffer wheels = CachedBuffers.partial(WIDE_COMICALLY_LARGE_WHEELS, Blocks.AIR.defaultBlockState());
        wheels.scale(1 - 1 / 512f)
                .translate(0, 1.5, 0)
                .rotateXDegrees(wheelAngle)
                .translate(0, 0, 0)
                .light(light)
        ...
        SuperByteBuffer pins = CachedBuffers.partial(WIDE_COMICALLY_LARGE_PINS, Blocks.AIR.defaultBlockState());
        pins.scale(1 - 1 / 512f)
                .translate(0, 1.5, 0)
                .rotateXDegrees(wheelAngle)
