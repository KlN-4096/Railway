...
package com.railwayteam.railways.content.custom_bogeys.visual.standard.triple_axle;
...
public class RadialBogeyVisual implements BogeyVisual {
    ...
    public RadialBogeyVisual(VisualizationContext ctx, float partialTick, boolean inContraption) {
        ...
        var wheelInstancer = ctx.instancerProvider()
                .instancer(InstanceTypes.TRANSFORMED, Models.partial(CR_BOGEY_WHEELS));
