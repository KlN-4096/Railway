...
// Visual imports - add these
import com.railwayteam.railways.content.custom_bogeys.visual.narrow.NarrowDoubleScotchYokeBogeyVisual;
import com.railwayteam.railways.content.custom_bogeys.visual.narrow.NarrowScotchYokeBogeyVisual;
import com.railwayteam.railways.content.custom_bogeys.visual.narrow.NarrowSmallBogeyVisual;
import com.railwayteam.railways.content.custom_bogeys.visual.standard.HandcarBogeyVisual;
import com.railwayteam.railways.content.custom_bogeys.visual.standard.double_axle.*;
import com.railwayteam.railways.content.custom_bogeys.visual.standard.large.*;
import com.railwayteam.railways.content.custom_bogeys.visual.standard.medium.*;
import com.railwayteam.railways.content.custom_bogeys.visual.standard.single_axle.*;
import com.railwayteam.railways.content.custom_bogeys.visual.standard.triple_axle.*;
...
public class CRBogeyStyles {
    ...
    public static final BogeyStyle MONOBOGEY = builder("monobogey", "monobogey")
            .displayName(Component.translatable("railways.bogeys.styles.monobogey"))
            .size(BogeySizes.SMALL, CRBlocks.MONO_BOGEY,
                    () -> () -> new SizeRenderer(
                            new MonoBogeyRenderer(),
                            MonoBogeyVisual::new
                    ))
            .build();

    public static final BogeyStyle INVISIBLE = builder("invisible", STANDARD_CYCLE_GROUP)
            .displayName(Component.translatable("railways.bogeys.styles.invisible"))
            .size(BogeySizes.SMALL, CRBlocks.INVISIBLE_BOGEY,
                    () -> () -> new SizeRenderer(
                            new InvisibleBogeyRenderer(),
                            InvisibleBogeyVisual::new
                    ))
            .contactParticle(new CubeParticleData())
            .build();

    public static final BogeyStyle INVISIBLE_MONOBOGEY = builder("invisible_monobogey", "monobogey")
            .displayName(Component.translatable("railways.bogeys.styles.invisible_monobogey"))
            .size(BogeySizes.SMALL, CRBlocks.INVISIBLE_MONO_BOGEY,
                    () -> () -> new SizeRenderer(
                            new InvisibleBogeyRenderer(),
                            InvisibleBogeyVisual::new
                    ))
    ...
    public static final BogeyStyle
            SINGLEAXLE = builder("singleaxle", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.SINGLEAXLE_BOGEY,
                    () -> () -> new SizeRenderer(
                            new SingleaxleBogeyRenderer(),
                            SingleaxleBogeyVisual::new
                    ))
            .build(),
            LEAFSPRING = builder("leafspring", SINGLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.SINGLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new LeafspringBogeyRenderer(),
                                    LeafspringBogeyVisual::new
                            ))
                    .build(),
            COILSPRING = builder("coilspring", SINGLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.SINGLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new CoilspringBogeyRenderer(),
                                    CoilspringBogeyVisual::new
                            ))
                    .build();

    // Double Axles
    public static final BogeyStyle
            FREIGHT = builder("freight", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY,
                    () -> () -> new SizeRenderer(
                            new FreightBogeyRenderer(),
                            FreightBogeyVisual::new
                    ))
            .build(),
            ARCHBAR = builder("archbar", DOUBLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new ArchbarBogeyRenderer(),
                                    ArchbarBogeyVisual::new
                            ))
                    .build(),
            PASSENGER = builder("passenger", DOUBLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new PassengerBogeyRenderer(),
                                    PassengerBogeyVisual::new
                            ))
                    .build(),
            MODERN = builder("modern", DOUBLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new ModernBogeyRenderer(),
                                    ModernBogeyVisual::new
                            ))
                    .build(),
            BLOMBERG = builder("blomberg", DOUBLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new BlombergBogeyRenderer(),
                                    BlombergBogeyVisual::new
                            ))
                    .build(),
            Y25 = builder("y25", DOUBLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new Y25BogeyRenderer(),
                                    Y25BogeyVisual::new
                            ))
                    .build();
    ...
    // Triple Axles
    public static final BogeyStyle
            HEAVYWEIGHT = builder("heavyweight", TRIPLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.TRIPLEAXLE_BOGEY,
                    () -> () -> new SizeRenderer(
                            new HeavyweightBogeyRenderer(),
                            HeavyweightBogeyVisual::new
                    ))
            .build(),
            RADIAL = builder("radial", TRIPLEAXLE_CYCLE_GROUP)
                    .size(BogeySizes.SMALL, CRBlocks.TRIPLEAXLE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new RadialBogeyRenderer(),
                                    RadialBogeyVisual::new
                            ))
                    .build();

    // Wide Bogeys
    public static final BogeyStyle
            WIDE_DEFAULT = builder("wide_default", STANDARD_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.WIDE_DOUBLEAXLE_BOGEY,
                    () -> () -> new SizeRenderer(
                            new WideDefaultBogeyRenderer(),
                            WideDefaultBogeyVisual::new
                    ))
            .size(BogeySizes.LARGE, CRBlocks.WIDE_SCOTCH_BOGEY,
                    () -> () -> new SizeRenderer(
                            new WideScotchYokeBogeyRenderer(),
                            WideScotchYokeBogeyVisual::new
                    ))
            .build(),
            WIDE_COMICALLY_LARGE = builder("wide_comically_large", STANDARD_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.wide_comically_large"))
                    .size(BogeySizes.LARGE, CRBlocks.WIDE_COMICALLY_LARGE_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new WideComicallyLargeScotchYokeBogeyRenderer(),
                                    WideComicallyLargeScotchYokeBogeyVisual::new
                            ))
                    .build();

    // Narrow Bogeys
    public static final BogeyStyle
            NARROW_DEFAULT = builder("narrow_default", STANDARD_CYCLE_GROUP)
            .displayName(Component.translatable("railways.bogeys.styles.narrow_default"))
            .size(BogeySizes.SMALL, CRBlocks.NARROW_SMALL_BOGEY,
                    () -> () -> new SizeRenderer(
                            new NarrowSmallBogeyRenderer(),
                            NarrowSmallBogeyVisual::new
                    ))
            .size(BogeySizes.LARGE, CRBlocks.NARROW_SCOTCH_BOGEY,
                    () -> () -> new SizeRenderer(
                            new NarrowScotchYokeBogeyRenderer(),
                            NarrowScotchYokeBogeyVisual::new
                    ))
            .build(),
            NARROW_DOUBLE_SCOTCH = builder("narrow_double_scotch", STANDARD_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.narrow_double_scotch"))
                    .size(BogeySizes.LARGE, CRBlocks.NARROW_DOUBLE_SCOTCH_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new NarrowDoubleScotchYokeBogeyRenderer(),
                                    NarrowDoubleScotchYokeBogeyVisual::new
                            ))
                    .build();

    // Handcar
    public static final BogeyStyle HANDCAR = builder("handcar", "handcar_cycle_group")
            .size(BogeySizes.SMALL, CRBlocks.HANDCAR,
                    () -> () -> new SizeRenderer(
                            new HandcarBogeyRenderer(),
                            HandcarBogeyVisual::new
                    ))
    ...
    // Medium
    public static final BogeyStyle
            MEDIUM_STANDARD = builder("medium_standard", DOUBLEAXLE_CYCLE_GROUP)
            .displayName(Component.translatable("railways.bogeys.styles.medium_standard"))
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_BOGEY,
                    () -> () -> new SizeRenderer(
                            new MediumStandardRenderer(),
                            MediumStandardVisual::new
                    ))
            .build(),
            MEDIUM_SINGLE_WHEEL = builder("medium_single_wheel", SINGLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_single_wheel"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_BOGEY,
                            () -> () -> new SizeRenderer(
                                    new MediumSingleWheelRenderer(),
                                    MediumSingleWheelVisual::new
                            ))
                    .build(),
            MEDIUM_TRIPLE_WHEEL = builder("medium_triple_wheel", TRIPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_triple_wheel"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new MediumTripleWheelRenderer(),
                                    MediumTripleWheelVisual::new
                            ))
                    .build(),
            MEDIUM_QUADRUPLE_WHEEL = builder("medium_quadruple_wheel", QUADRUPLEAXLE_CYCLE_GROUP)
                    ...
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUADRUPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new MediumQuadrupleWheelRenderer(),
                                    MediumQuadrupleWheelVisual::new
                            ))
                    .build(),
            MEDIUM_QUINTUPLE_WHEEL = builder("medium_quintuple_wheel", QUINTUPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_quintuple_wheel"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUINTUPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new MediumQuintupleWheelRenderer(),
                                    MediumQuintupleWheelVisual::new
                            ))
                    .build(),
            MEDIUM_2_0_2_TRAILING = builder("medium_2_0_2_trailing", SINGLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_2_0_2_trailing"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_2_0_2_TRAILING,
                            () -> () -> new SizeRenderer(
                                    new Medium202TrailingRenderer(),
                                    Medium202TrailingVisual::new
                            ))
                    .build(),
            MEDIUM_4_0_4_TRAILING = builder("medium_4_0_4_trailing", DOUBLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_4_0_4_trailing"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_4_0_4_TRAILING,
                            () -> () -> new SizeRenderer(
                                    new Medium404TrailingRenderer(),
                                    Medium404TrailingVisual::new
                            ))
                    .build(),
            MEDIUM_6_0_6_TRAILING = builder("medium_6_0_6_trailing", TRIPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_6_0_6_trailing"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new Medium606TrailingRenderer(),
                                    Medium606TrailingVisual::new
                            ))
                    .build(),
            MEDIUM_6_0_6_TENDER = builder("medium_6_0_6_tender", TRIPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_6_0_6_tender"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new Medium606TenderRenderer(),
                                    Medium606TenderVisual::new
                            ))
                    .build(),
            MEDIUM_8_0_8_TENDER = builder("medium_8_0_8_tender", QUADRUPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_8_0_8_tender"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUADRUPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new Medium808TenderRenderer(),
                                    Medium808TenderVisual::new
                            ))
                    .build(),
            MEDIUM_10_0_10_TENDER = builder("medium_10_0_10_tender", QUINTUPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.medium_10_0_10_tender"))
                    .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUINTUPLE_WHEEL,
                            () -> () -> new SizeRenderer(
                                    new Medium10010TenderRenderer(),
                                    Medium10010TenderVisual::new
                            ))
                    .build();

    // Large
    public static final BogeyStyle
            LARGE_CREATE_STYLED_0_4_0 = builder("large_create_style_0_4_0", DOUBLEAXLE_CYCLE_GROUP)
            .displayName(Component.translatable("railways.bogeys.styles.large_create_style_0_4_0"))
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_4_0,
                    () -> () -> new SizeRenderer(
                            new LargeCreateStyled040Renderer(),
                            LargeCreateStyled040Visual::new
                    ))
            .build(),
            LARGE_CREATE_STYLED_0_6_0 = builder("large_create_style_0_6_0", TRIPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.large_create_style_0_6_0"))
                    .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_6_0,
                            () -> () -> new SizeRenderer(
                                    new LargeCreateStyled060Renderer(),
                                    LargeCreateStyled060Visual::new
                            ))
                    .build(),
            LARGE_CREATE_STYLED_0_8_0 = builder("large_create_style_0_8_0", QUADRUPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.large_create_style_0_8_0"))
                    .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_8_0,
                            () -> () -> new SizeRenderer(
                                    new LargeCreateStyled080Renderer(),
                                    LargeCreateStyled080Visual::new
                            ))
                    .build(),
            LARGE_CREATE_STYLED_0_10_0 = builder("large_create_style_0_10_0", QUINTUPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.large_create_style_0_10_0"))
                    .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_10_0,
                            () -> () -> new SizeRenderer(
                                    new LargeCreateStyled0100Renderer(),
                                    LargeCreateStyled0100Visual::new
                            ))
                    .build(),
            LARGE_CREATE_STYLED_0_12_0 = builder("large_create_style_0_12_0", SEXTUPLEAXLE_CYCLE_GROUP)
                    .displayName(Component.translatable("railways.bogeys.styles.large_create_style_0_12_0"))
                    .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_12_0,
                            () -> () -> new SizeRenderer(
                                    new LargeCreateStyled0120Renderer(),
                                    LargeCreateStyled0120Visual::new
                            ))
                    .build();


    public static BogeyStyle.Builder builder(String name, String cycleGroup) {
        return builder(Railways.asResource(name), Railways.asResource(cycleGroup))
                .displayName(Component.translatable("railways.bogeys.styles." + name));
    }

    public static BogeyStyle.Builder builder(String name, ResourceLocation cycleGroup) {
        return builder(Railways.asResource(name), cycleGroup);
    }

    public static BogeyStyle.Builder builder(ResourceLocation name, ResourceLocation cycleGroup) {
